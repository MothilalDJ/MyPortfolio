  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        {['Projects', 'Architecture', 'Skills', 'Education', 'Contact'].map(item => (
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
        {/* Status badge */}
        <div
          className="flex items-center gap-2 px-4 py-2 rounded-full mb-8 font-mono text-xs"
        ...
        >
          ...
          MADURAI, TAMIL NADU &nbsp;•&nbsp; M.SC COMPUTER SCIENCE
        </div>
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl font-light mt-4 mb-10 max-w-2xl leading-relaxed" style={{ color: 'rgba(156,163,175,0.85)' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <a
            href="#projects"
            className="px-7 py-3.5 rounded-2xl font-semibold text-sm text-black transition-all duration-200"
          ...
          <a
            ...
            className="glass px-7 py-3.5 rounded-2xl font-medium text-sm transition-all duration-200"
        ...
        {/* Stats row */}
        <div className="flex items-center gap-8 mt-16 pt-8" style={{ borderTop: '1px solid rgba(30,34,45,0.8)' }}>
          {[
            ...
            <div key={stat.label} className="flex flex-col items-center gap-1">
              <span className="font-mono text-2xl font-bold" style={{ color: '#34D399' }}>{stat.value}</span>
              <span className="text-xs" style={{ color: 'rgba(107,114,128,1)' }}>{stat.sub}</span>
            </div>
          ))}
        </div>
      </div>
              ...
              <div key={node.id} className="flex flex-col items-center w-full max-w-md">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="font-mono text-xs mt-0.5" style={{ color: 'rgba(107,114,128,1)' }}>{node.sub}</div>
                  </div>
                  <div className="w-2 h-2 rounded-full bg-emerald-400" style={{ boxShadow: '0 0 6px rgba(16,185,129,0.8)' }} />
                </div>
    ...
    <section id="education" className="py-24 px-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2">
          <div
            className="rounded-2xl p-7 h-full flex flex-col justify-center items-center text-center relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div
                className="font-mono font-bold text-6xl mb-2"
...
function TerminalSection() {
  ...
  return (
    <section id="terminal" className="py-24 px-6 max-w-3xl mx-auto" ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {contacts.map(c => (
            <a
              ...
              rel="noopener noreferrer"
              className="glass-card rounded-2xl p-5 flex items-center gap-4 text-left group"
            >
              <div
              ...
              <div className="ml-auto text-gray-600 group-hover:text-emerald-400 transition-colors duration-200">→</div>
            </a>
          ))}
        </div>
      </div>
